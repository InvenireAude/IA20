...
/*************************************************************************/
std::string MiscTools::StrToHex(const std::string& strData){
...
/*************************************************************************/
std::string MiscTools::StrToPrintableAndHex(const std::string& strData){
...
/*************************************************************************/
std::string MiscTools::CharToHex(const char cChar){
	IA20_TRACER;
	std::string strResult;
...
/*************************************************************************/
std::string MiscTools::StrToPrintableOrHex(const std::string& strData){
...
unsigned char MiscTools::HexValue(char cValue){
	...
	if(cValue >= '0' && cValue <= '9')
	    ...
	    IA20_THROW(BadUsageException(std::string("Hex value out of range.")+TypeTools::IntToString(cValue)+"["+cValue+"]"));

}
/*************************************************************************/
void  MiscTools::BinarytoHex(unsigned char *sData, size_t iDataLen, std::string& strOutput){
	IA20_TRACER;
...
/*************************************************************************/
std::string  MiscTools::BinarytoHex(unsigned char *sData, size_t iDataLen){
	IA20_TRACER;
...
/*************************************************************************/
void  MiscTools::HexToBinary(const std::string& strInput, unsigned char *sData, size_t iBufLen){
	IA20_TRACER;
...
/*************************************************************************/
void MiscTools::CopyStreamsUntilBoundary(std::istream& is, std::ostream& os, const std::string& strBoundary){
	IA20_TRACER;

	std::string::size_type iBoundaryIdx = 0;
...
/*************************************************************************/
std::string MiscTools::StreamToString(std::istream& is){
	IA20_TRACER;
...
/*************************************************************************/
static const std::string CBase64 =
...
/*************************************************************************/
void MiscTools::StringToBase64(const std::string& strInput, std::string& strOutput){
...
//TODO rewrite
/*************************************************************************/
void  MiscTools::BinaryToBase64(const unsigned  char *sData, size_t iDataLen, std::string& strOutput){
...
/*************************************************************************/
void MiscTools::Base64ToBinary(const std::string& strInput, unsigned char *sData, size_t iBufferLen, size_t &iDataLen){
...
/*************************************************************************/
void MiscTools::Base64ToString(const std::string& strInput, std::string& strOutput){
...
/*************************************************************************/
std::string MiscTools::StrToLower(const std::string& strData){
...
/*************************************************************************/
std::string MiscTools::StrToUpper(const std::string& strData){
